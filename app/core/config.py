...
class Settings(BaseSettings):
    ...
    ai_direction_shift_daily_call_limit: int = Field(default=2, ge=0, le=10)
    ai_direction_shift_cooldown_seconds: int = Field(default=1800, ge=300, le=14_400)
    ai_direction_shift_probability_delta: int = Field(default=12, ge=5, le=40)
